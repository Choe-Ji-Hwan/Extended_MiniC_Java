...
public class Token {
    ...
    // (add) keyword
    // Char, Double, For, Do, Goto, Switch, Case, Break, Default, Colon,
    ...
    public static Token mkCharLiteral (String name) {
    	return new Token(TokenType.CharacterLiteral, name);
    }
    // (add) stringLiteral
